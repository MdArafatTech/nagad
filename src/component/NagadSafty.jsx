...
const NagadSafty = () => {
    ...
    return (
        ...
        <div className=" px-[7%] py-6 space-y-6">
            ...
            {safetyInfo && (
                <div className="space-y-4 p-5 rounded-2xl bg-white text-black">
                    <h2 className="text-2xl font-bold">Fraud Prevention</h2>
                    <p className="text-lg">{safetyInfo.fraudPrevention.warning}</p>

                    <h3 className="text-xl font-semibold mt-4">Common Scam Techniques:</h3>
                    ...
                    <h3 className="text-xl font-semibold mt-4">Precautionary Measures:</h3>
                    <ul className="list-disc list-inside">
