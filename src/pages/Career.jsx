  ...
  return (
    <div className="px-2">
      <img
        src={careerImg}
        alt="Career at Nagad"
    className='w-full h-47 md:mt-0 md:h-85 lg:h-full mt-22  lg:mt-0 rounded-xl lg:rounded-none'm
      />

      {/* Career intro */}
      <div className="w-full max-w-4xl mx-auto text-center p-6 md:p-10 rounded-xl bg-white mb-10 shadow-xl mt-8">
